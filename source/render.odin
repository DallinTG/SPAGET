...
draw_by_id_2d::proc(
    ...
    atlas:rl.Texture2D=g_mem.assets.atlas
){
...
draw_animation::proc(
    ...
    draw_texture_3d(atlas, atlas_textures[g_mem.assets.animations.global[animation_name].current_frame].rect, dest, z,origin, rot, tint)
}
draw_image::proc(
    name:img_ani_name,
    dest:Rect,
    ...
    switch id in name{
        case Animation_Name: draw_texture_3d(atlas, atlas_textures[g_mem.assets.animations.global[id].current_frame].rect, dest, z,origin, rot, tint)        
